...
export const RAW_MENU_ITEMS: RawItemData[] = [
  ...
  },
  {
    ...
    desc: "Layered Mumbai street-style sandwich with spiced potatoes, cucumber, beetroot, tomato, house mint chutney, butter and melted cheese.",
    ingredients: "Bread, potato masala, cucumber, beetroot, tomato, green chutney, cheese, butter",
    prep: "Masala potato; mint chutney; sliced vegetables",
    equipment: "Panini grill / OTG",
    ware: "10 in main plate",
    price: 169,
    ceiling: 179,
  ...
  },
  {
    ...
    desc: "Grilled artisanal sandwich loaded with spiced cottage cheese cubes, crunchy bell peppers, sweet corn, melted mozzarella and tangy mint spread.",
    ingredients: "Bread, paneer, bell peppers, corn, onion, mozzarella, mint chutney, house spices",
    prep: "Spiced paneer marinade; chopped bell peppers; mint chutney",
    equipment: "Panini grill / OTG",
    ware: "10 in main plate",
    price: 189,
    ceiling: 199,
    avail: "All Day",
    pairing: "Classic Cold Coffee / Smol Chai",
    saathi: true,
    dietary: "Vegetarian",
    protein: "High",
    spice: "Medium",
  ...
  },
  {
    ...
    desc: "Slow-cooked Kashmiri rajma in spiced onion-tomato gravy served with fragrant steamed rice, pickled onions, creamy curd and crisp papad crunch.",
    ingredients: "Rajma, basmati rice, tomato-onion masala, yoghurt, pickled onion, papad crunch",
    prep: "Soaked/cooked rajma; homestyle gravy; steamed basmati rice",
  ...
  },
  {
    ...
    desc: "Succulent paneer cubes and crunchy bell peppers tossed in fresh-ground kadai masala gravy, served over fragrant jeera rice with pickled onions and mint raita.",
    ingredients: "Paneer, bell peppers, tomato-onion kadai gravy, jeera rice, cumin, coriander seeds, pickled onion",
    prep: "Kadai masala gravy; paneer cubes; jeera rice; pickled onion",
    equipment: "Gas / wok",
    ware: "9 in universal deep bowl",
    price: 199,
    ceiling: 209,
    avail: "All Day",
    pairing: "Masala Chaas / Buransh Fizz",
    saathi: false,
    dietary: "Vegetarian",
    protein: "High",
    spice: "Medium",
  ...
  },
  {
    ...
    desc: "Aromatic basmati rice tempered with pure desi ghee and toasted cumin, served with homestyle dal tadka, cucumber raita and crisp papad.",
    ingredients: "Basmati rice, cumin, desi ghee, yellow dal tadka, cucumber raita, papad, pickle",
    prep: "Jeera rice; yellow dal; raita; roasted papad",
    equipment: "Gas / pressure cooker",
    ware: "9 in universal deep bowl",
    price: 139,
    ceiling: 149,
    avail: "All Day",
    pairing: "Masala Chaas / Smol Chai",
    saathi: false,
    dietary: "Vegetarian",
    protein: "Medium",
    spice: "Mild",
  ...
  },
  {
    cat: "Bowls & Comfort",
    sub: "Comfort Bowl",
    name: "Creamy Mushroom Rice Bowl",
    desc: "Velvety garlic-herb sautéed mushrooms over warm herbed butter rice with roasted vegetables and crisp salad side.",
  ...
  },
  {
    ...
    desc: "Golden crispy fried sweet corn tossed with tangy chaat masala, diced onions, tomatoes, green chillies and fresh lime juice.",
    ingredients: "Corn, onion, tomato, green chilli, lime, chaat masala, fresh coriander",
    prep: "Portion corn; chaat seasoning mise en place",
  ...
  },
  {
    ...
    sub: "Snack",
    name: "French Fries",
    desc: "Golden crispy potato fries lightly dusted with sea salt and peri-peri seasoning, served with garlic mayo dip.",
    ingredients: "Potatoes, sea salt, peri-peri seasoning, garlic mayo dip",
    prep: "Portion fries; spice dusting",
    equipment: "Air fryer / fryer",
    ware: "Small serving bowl",
    price: 119,
    ceiling: 139,
    avail: "All Day",
    pairing: "Classic Cold Coffee / Fresh Lime Soda",
    saathi: false,
    dietary: "Vegetarian",
    protein: "Low",
    spice: "Mild-Medium",
  ...
  },
  {
    cat: "Got the Munchies",
    sub: "Snack",
    name: "Chilli Cheese Toasts",
    desc: "Artisanal crusty bread slices loaded with melted cheddar & mozzarella, finely chopped green chillies, bell peppers and herbs.",
    ingredients: "Bread, cheddar & mozzarella cheese, green chilli, bell pepper, herbs, butter",
    prep: "Spiced cheese mix; slice bread",
    equipment: "OTG / grill",
    ware: "7–8 in side plate",
    price: 129,
    ceiling: 139,
  ...
  },
  {
    cat: "There's Always Room",
    sub: "Dessert",
    name: "Cake for Dessert",
    desc: "Freshly baked rich chocolate fudge cake slice with velvety Belgian chocolate ganache and chocolate curls.",
    ingredients: "Cocoa, flour, Belgian chocolate ganache, butter, sugar, chocolate curls",
    prep: "Bake daily artisanal cake; portion slices",
    equipment: "OTG / Bakery display",
    ware: "7–8 in side plate",
    price: 159,
    ceiling: 179,
    avail: "All Day",
    pairing: "Tapovan Pour Over / Cappuccino",
    saathi: false,
    dietary: "Vegetarian",
    protein: "Low",
    spice: "None",
    status: "ACTIVE",
    notes: "Signature daily rotating dessert cake slice.",
  },
  {
